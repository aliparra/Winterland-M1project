...
<img src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/init/winterland.png?raw=true'></br>
# ENGLISH README</br>
### INTRODUCTION 

##### (This game has been developed as the first project after finishing the first module of the Full Stack web development Ironhack's bootcamp ) </br></br>
Winterland is a platform game inspired by the winter world, where ice and snow are present all the time. 
The aim is to get Joe, the main character, to take as many coins as possible to his grandmother, who has been trapped by the snowstorm.
Through the keyboard controls, the player must overcome obstacles, avoid and eliminate enemies, jump from a platform 
to another avoiding falling into the void and obtaining the maximum amount of coins possible. 
The final score will be obtained based on the number of coins obtained at the end of the game. One, two or three stars may be achieved. 

### HOW TO PLAY

- To start, press the start button in the centre of the screen. 
- To pause the game, press the pause button on the left side of the screen.
- To reload the page, press the reload button that will appear on the left of the screen once the game has started.
- To mute the music click on the <img align="center" alt="Stop Music Button" width="50px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/Music_BTN.png?raw=true'>
- To resume the music press the button <img align="center" alt="Restart Music Button" width="50px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/Music_BTN_Off.png?raw=true'>
- To mute, press the <img align="center" alt="Stop Sounds Button" width="50px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/Sound_BTN.png?raw=true'>
- To resume the character sounds and collisions with enemies press the <img align="center" alt="Restart Sounds Button" width="50px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/Sounds_BTN_Off.png?raw=true'>

### CHARACTER MOVEMENT CONTROLS

- To walk press right and left arrows
- To jump press up arrow
- To run to the right, press right arrow and the letter D simultaneously
- To run to the right, press left arrow and the letter D simultaneously
- To jump further, press the left/right arrow, up arrow and the D arrow simultaneously
- To shoot (Only avaiable if you have obtained a snowball type object) press the space bar
...
### SPECIAL OBJECTS AND ENEMIES

**OBJECTS** </br>
(It is necessary to collide with the objects to obtain them)
- <img align="left" alt="Snowball" width="20px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Bubble.png?raw=true'>**Snowball**: Allows you to throw snowballs for 20 seconds to eliminate both flying and Earth enemies.
- <img align="left" alt="Heart" width="20px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Life.png?raw=true'> **The heart**: Increases the size of the character and gives it an extra life.
- <img align="left" alt="Apple" width="20px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Apple.png?raw=true'> **The apple**: Decreases the size of the character so that it can access places with reduced dimensions. 
- <img align="left" alt="Currency" width="20px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Coin_01.png?raw=true'> **Coin**: Increases the point counter that will be taken into account for the score at the end of the game. 

**ENEMIES** </br>
There are two types of enemies, flying and grounded.</br>
<img align="left" alt="Flying enemy" width="30px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/enemySprite/Screenshot2%20at%20Jan%2011%2012-12-19.png?raw=true'> - **Flying enemies** (Purple face): You can choose to avoid them. They can only be eliminated by throwing a snowball at them. </br></br>
<img align="left" alt="Earth enemy" width="30px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/enemySprite/Screenshot%20at%20Jan%2011%2012-11-53.png?raw=true'> </br> - **Earth enemies** (Blue face): You can eliminate them by jumping or throwing a snowball at them.


**TRAPS AND MOBILE PLATFORMS**
- <img align="left" alt="Spike trap" width="40px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Platformer/Spikes.png?raw=true'> **Ice spike trap:** It will appear when the character is a few meters away from it. It will emit a characteristic sound. It is necessary to avoid it by jumping.
- <img align="left" alt="Moving platforms " width="40px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Environment/Icicle_02.png?raw=true'> **Moving platforms:** They move from one side to the other covering a certain distance.
- <img align="left" alt="Slippery platform" width="40px" src= 'https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Platformer/Screenshot%20at%20Jan%2011%2012-15-03.png?raw=true'> **Slippery ice platforms:** The character will slide to the right or left, being necessary to walk or run to avoid falling into the void.

### END OF THE GAME

- <img align="left" alt="Level not achieved" width="100px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/HeaderFailed.png?raw=true'> **NON-COMPLETED LEVEL**: If the character's life ends, a screen will appear showing the level not achieved sign. It is necessary to reload the game to try again.

- <img align="left" alt="Level completed" width="100px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/Buttons/Header.png?raw=true'> **LEVEL COMPLETED**: If you reach the final part of the game you will be able to obtain a luminous object that will end the level showing the score obtained and the number of stars achieved:</br>

**FINAL SCORE**:</br></br>
<img align="left" alt="Star" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> 1-10 Coins </br></br>
<img align="left" alt="Estrella" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> <img align="left" alt="Estrella" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> 11-20 Coins </br></br></br>
<img align="left" alt="Estrella" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> <img align="left" alt="Estrella" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> <img align="left" alt="Estrella" width="40px" src='https://github.com/aliparra/Winterland-M1project/blob/master/WINTERLAND-GAME/assets/img/CollectableObject/Star_01.png?raw=true'> +20 Coins
...
El objetivo es conseguir que Joe, el personaje principal lleve la máxima cantidad de monedas posibles a su abuela, que ha quedado atrapada por la tormenta de nieve. 
